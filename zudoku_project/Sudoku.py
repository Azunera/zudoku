#!/usr/bin/env python3
from PySide6.QtWidgets import QApplication, QMainWindow, QWidget, QVBoxLayout, QLabel, QPushButton, QGridLayout, QSizePolicy, QFontComboBox, QColorDialog
...
class MainWindow(QMainWindow):
    def __init__(self):
       ...
       # Load game data if available
        ...
        # right_sidebar_layout.addWidget(color_dialog)
    ...
    def game_reseter(self, difficulty):
        ...
        self.sudoku.generate_sudoku(difficulty)
    ...
    def save_game(self):
        ...
        with open('zudoku_project/sudoku_save.json', 'w') as sufile:
